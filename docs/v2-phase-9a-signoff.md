...
Rate limiting is covered by focused unit tests and API header smoke tests.
A full auth-route rate-limit integration test and distributed limiter backend are deferred to production hardening / deployment phase.
